...
import { LogOut, Loader2, HelpCircle, DollarSign, Shield, Users, Settings as SettingsIcon, EyeOff, UserX } from 'lucide-react';
...
import type { CurrentUser, BlockedUser } from './social-dashboard';
...
export default function SettingsView({ user, onSignOut, onUpdateProfile, onPasswordReset, onDeleteAccount, blockedUsers, onUnblockUser }: SettingsViewProps) {
        ...
        <main className="col-span-9 space-y-8">
            ...
            <Tabs defaultValue="account" className="w-full">
                <TabsList className="grid w-full grid-cols-5">
                    ...
                    {user.isProfessional && <TabsTrigger value="monetization"><DollarSign className="mr-2 h-4 w-4" />Wallet</TabsTrigger>}
                                        ...
                                        <CardContent className="p-4 space-y-2">
                                            {blockedUsers.map(blockedUser => (
                                                <div key={blockedUser.uid} className="flex items-center justify-between">
                                                    ...
                                                    <Button variant="outline" size="sm" onClick={() => onUnblockUser(blockedUser.uid)}>Unblock</Button>
                                                </div>
                                            ))}
                                        </CardContent>
                                    </Card>
