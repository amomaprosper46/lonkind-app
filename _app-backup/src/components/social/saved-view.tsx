...
export default function SavedView({ currentUser, onReact, onComment, onSavePost, onDeletePost, userReactions, savedPostIds, onReportPost, onMuteUser }: SavedViewProps) {
