...
import { Loader2, Wand, Share } from 'lucide-react';
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Write a short story, and the AI Director will turn it into a narrated video with multiple scenes.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <Button onClick={handleGenerate} disabled={isLoading || isPosting} className="w-full">
                    {isLoading ? <Loader2 className="h-5 w-5 animate-spin" /> : <><Wand className="mr-2 h-5 w-5" /> Generate Video Story</>}
                </Button>
