                        ...
                        <CarouselItem>
                            <Card className="bg-secondary/50">
                                <CardContent className="flex flex-col aspect-square items-center justify-center p-6 text-center">
                                    ...
                                    <h3 className="text-xl font-semibold">1. Discover & Connect</h3>
                                    <p className="text-muted-foreground mt-2">
                                        Head to the "Trending" page to discover popular posts, or check out "Groups" to find your community. Add friends to see their posts on your home feed.
                                    </p>
                                </CardContent>
                            </Card>
                        </CarouselItem>
