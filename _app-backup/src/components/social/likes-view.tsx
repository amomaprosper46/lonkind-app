...
export default function LikesView({ userId, currentUser, onReact, onComment, onSavePost, onDeletePost, userReactions, savedPostIds, onReportPost, onMuteUser }: LikesViewProps) {
