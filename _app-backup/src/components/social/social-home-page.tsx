...
import { signOut, User, sendPasswordResetEmail, RecaptchaVerifier, updateProfile, createUserWithEmailAndPassword } from 'firebase/auth';
...
export default function SocialHomePage() {
  ...
  const AppContent = () => {
      if (user) {
        if (isNewUser) {
            return <SignUpWizard user={user} onProfileCreated={() => {
                setIsNewUser(false);
